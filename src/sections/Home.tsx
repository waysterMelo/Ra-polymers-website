  ...
  return (
    <section className="panel relative overflow-hidden bg-slate-300 flex items-center justify-center">
      ...
      <div className="relative z-10 w-full max-w-5xl mx-auto px-6">
        <div className="flex flex-col items-center justify-center text-center bg-white/50 backdrop-blur-md border border-white/60 p-12 md:p-24 rounded-3xl shadow-2xl">
