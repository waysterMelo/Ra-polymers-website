...
export default function App() {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Dedicated trigger for the Mold Animation in Panel 4
          ...
          {[0, 1, 2, 3, 4, 5].map((i) => (
            <div 
              ...
              className={cn(
                ...
                Math.floor(scrollProgress * 5.9) === i ? "bg-ra-blue h-12" : "bg-white/10"
              )}
            />
          ))}
        </div>
      ...
      <main ref={containerRef} className={cn(isMobile ? "flex flex-col" : "horizontal-scroll-container")}>
        ...
        <section className="panel relative bg-ra-dark overflow-hidden">
          ...
          <div className="h-full flex flex-col justify-center px-12 md:px-24 relative z-10">
            <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-16 items-center mx-auto">
              ...
              <div className="space-y-8">
                ...
                <div className="w-12 h-1 bg-ra-blue"></div>
                ...
                <div className="flex gap-12 pt-4">
                  <div>
                    <p className="text-4xl font-mono text-white font-bold">20+</p>
                    <p className="text-[10px] uppercase tracking-widest text-ra-blue mt-2">Anos de Mercado</p>
                  </div>
                  <div>
                    <p className="text-4xl font-mono text-white font-bold">100%</p>
                    <p className="text-[10px] uppercase tracking-widest text-ra-blue mt-2">Ferramentaria Própria</p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-[400px] md:h-[500px] rounded-2xl overflow-hidden group">
                <div className="absolute inset-0 bg-ra-blue/20 mix-blend-overlay z-10 group-hover:bg-transparent transition-colors duration-700 pointer-events-none"></div>
                <img 
                ...
                <div className="absolute inset-4 border border-white/20 z-20 pointer-events-none transition-all duration-700 group-hover:inset-2">
                  ...
                  <div className="absolute top-0 right-0 w-4 h-4 border-t-2 border-r-2 border-ra-blue translate-x-[1px] -translate-y-[1px]"></div>
                  <div className="absolute bottom-0 left-0 w-4 h-4 border-b-2 border-l-2 border-ra-blue -translate-x-[1px] translate-y-[1px]"></div>
        ...
        <section className="panel relative bg-ra-dark overflow-hidden">
          ...
          <div className="absolute inset-0 z-0">
            <img 
              ...
              referrerPolicy="no-referrer"
            />
            {/* Gradient overlay to blend smoothly from the previous section */}
